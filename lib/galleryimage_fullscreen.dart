...
class GalleryImageFullscreen extends StatefulWidget {
  ...
  @override
  State<GalleryImageFullscreen> createState() => _GalleryImageState();
}

class _GalleryImageState extends State<GalleryImageFullscreen> {
  ...
  @override
  void didUpdateWidget(covariant GalleryImageFullscreen oldWidget) {
    _buildItemsList(widget.imageUrls, widget.httpHeaders);
